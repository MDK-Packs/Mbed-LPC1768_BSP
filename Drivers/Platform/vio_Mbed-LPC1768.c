...
/*! \page vio_Mbed-LPC1768 Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

Virtual Resource  | Variable       | Physical Resource on MBED LPC1768              |
:-----------------|:---------------|:-----------------------------------------------|
vioLED0           | vioSignalOut.0 | P1_18 : GPIO[18]                               |
vioLED1           | vioSignalOut.1 | P1_20 : GPIO[20]                               |
vioLED2           | vioSignalOut.2 | P1_21 : GPIO[21]                               |
vioLED3           | vioSignalOut.3 | P1_23 : GPIO[23]                               |
*/
...
void vioInit(void)
{
    ...
    PIN_Configure(1, 18, PIN_FUNC_0, PIN_PINMODE_PULLDOWN, PIN_PINMODE_NORMAL);
    GPIO_SetDir(1, 18, GPIO_DIR_OUTPUT);
    GPIO_PinWrite(1, 18, 0U);
    // Configure pins: Output Mode with Pull-down resistors, LED1
    PIN_Configure(1, 20, PIN_FUNC_0, PIN_PINMODE_PULLDOWN, PIN_PINMODE_NORMAL);
    GPIO_SetDir(1, 20, GPIO_DIR_OUTPUT);
    GPIO_PinWrite(1, 20, 0U);
    // Configure pins: Output Mode with Pull-down resistors, LED2
    PIN_Configure(1, 21, PIN_FUNC_0, PIN_PINMODE_PULLDOWN, PIN_PINMODE_NORMAL);
    GPIO_SetDir(1, 21, GPIO_DIR_OUTPUT);
    GPIO_PinWrite(1, 21, 0U);
    // Configure pins: Output Mode with Pull-down resistors, LED3
    PIN_Configure(1, 23, PIN_FUNC_0, PIN_PINMODE_PULLDOWN, PIN_PINMODE_NORMAL);
    GPIO_SetDir(1, 23, GPIO_DIR_OUTPUT);
    GPIO_PinWrite(1, 23, 0U);
#endif
